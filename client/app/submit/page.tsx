...
export default function SubmitPage() {
      ...
      <div className="max-w-2xl mx-auto px-4 py-24 text-center">
        <div className="glass rounded-3xl p-12 relative overflow-hidden">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-lg mx-auto">
            Your prompt has been successfully submitted and is currently <span className="text-brand-cyan font-bold">pending review</span>. You will be notified once it is approved.
          </p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <Link href="/" className="inline-flex items-center text-sm font-medium text-gray-400 hover:text-white transition-colors mb-8">
      ...
      <form onSubmit={handleSubmit} className="glass rounded-3xl p-8 md:p-12 relative overflow-hidden border-white/10 space-y-6">
        ...
        <div>
          <label htmlFor="content" className="block text-sm font-medium text-gray-300 mb-2">Prompt Content</label>
          <textarea
            id="content"
            rows={8}
            required
